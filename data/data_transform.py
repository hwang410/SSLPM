...
def get_data(path, data, *args):
    ...
    ssl_transform = FixMatchTransform(data)
    ...
    if data == 'cifar10' or data == 'cifar10_imbalanced':
        ...
        ssl_transform_data = CIFAR10(path, train=True, download=False, transform=ssl_transform)
        ...
        ssl_transform_data = CIFAR100(path, train=True, download=False, transform=ssl_transform)
        ...
        ssl_transform_data = FashionMNIST(path, train=True, download=False, transform=ssl_transform)
        ...
        ssl_transform_data = MyDataset(train_inputs, train_labels, transform=ssl_transform)
    ...
    return train_transform_data, ssl_transform_data, test_transform_data, evaluate_transform_data
